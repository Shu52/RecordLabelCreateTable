...
CREATE TABLE `Album` (
	...
	FOREIGN KEY(`RecordLabelId`) REFERENCES `RecordLabel`(`LabelId`),
...
/* List all songs with album informatition */
SELECT s.Title 'Song', a.Title 'Album', l.LabelName 'Record Label'
FROM Song s
LEFT Join Album a ON s.AlbumId = a.AlbumId
Left JOIN RecordLabel l ON a.RecordLabelId = l.LabelId;
